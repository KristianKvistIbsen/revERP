...
def mobius_area_correction_spherical(v, f, map_coords):
    ...
    Parameters:
        v: numpy array (nv x 3) vertex coordinates of a genus-0 closed triangle mesh
        f: numpy array (nf x 3) triangulations of a genus-0 closed triangle mesh
        map_coords: numpy array (nv x 3) vertex coordinates of the spherical conformal parameterization
    
    Returns:
        map_mobius: numpy array (nv x 3) vertex coordinates of the updated spherical conformal parameterization
        x: optimal parameters for the Mobius transformation
    """
